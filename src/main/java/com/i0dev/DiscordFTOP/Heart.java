package com.i0dev.DiscordFTOP;

import com.i0dev.DiscordFTOP.commands.CmdDiscordFTOP;
...
import com.i0dev.DiscordFTOP.templates.AbstractListener;
...
public class Heart extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        managers.addAll(Arrays.asList(
                ...
                new CmdDiscordFTOP(this, "discordFTOP")
        ));
    ...
    public DiscordManager dManager() {
        return getManager(DiscordManager.class);
    }
